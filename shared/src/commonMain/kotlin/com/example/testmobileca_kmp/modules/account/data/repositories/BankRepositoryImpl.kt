...
import com.example.testmobileca_kmp.modules.account.data.datasources.LocalBankDataSource
...
class BankRepositoryImpl : BankRepositoryProtocol {
    ...
    override suspend fun fetchBanks(): Result<List<Bank>> {
        return try {
            ...
            // Offline fallback — read from embedded local JSON
            LocalBankDataSource.fetchBanks()
        }
    }
}
